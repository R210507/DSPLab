...
x = list(map(int, input("Enter the values for the first signal x (comma-separated): ").split(',')))
h = list(map(int, input("Enter the values for the second signal h (comma-separated): ").split(',')))
